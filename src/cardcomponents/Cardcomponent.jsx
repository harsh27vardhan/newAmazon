import img1 from "../assets/amazonproduct1.jpg";
import img2 from "../assets/amazonproduct2.jpg";
import img3 from "../assets/amazonproduct3.jpg";
import img4 from "../assets/amazonproduct4.jpg";
import ProductCard from "../cart/product";

function Card() {
  return (
    <div className="container flex justify-center items-center flex-wrap pt-10 gap-5 absolute top-[38%]">
      {cardData.map((card, index) => (
        <div
        className="cardcontainer flex flex-col h-[405px] w-[350px] shadow-[2px_4px_5px_5px_rgb(217,216,216)] bg-white"
        key={index}
      >
        <h2 className="p-5 font-bold text-xl">{card.title}</h2>
        <div className="productContainer flex flex-wrap gap-2 justify-start p-4">
          {card.items.map((item, itemIndex) => (
            <div
              className="flex flex-col items-center w-[45%] mb-2" 
              key={itemIndex}
            >
              <img src={item.img} alt={item.title} className="w-[80%] mb-2" />
        ...
        <a
          href={card.link}
          className="all-[unset] cursor-pointer text-[rgb(76,157,157)] pl-[30px]"
        >
          See more
        </a>
      </div>
      ))}
      <div className="products w-full flex flex-wrap--x overflow-auto justify-between gap-4 mx-auto shadow-[2px_4px_5px_5px_rgb(217,216,216)]">
...
const cardData = [
    {
      ...
      items: [
        { img: img1, title: "Air Conditioner" },
        { img: img2, title: "Refrigerator" },
        { img: img3, title: "Microwaves" },
        { img: img4, title: "Washing Machines" },
      ],
    },
    {
      title: "Appliances for your home | Up to 55% off",
